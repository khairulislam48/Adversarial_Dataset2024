...
# # Calculate the predictions and true labels for the entire validation set
# val_true_labels = []
# val_pred_labels = []
# model.eval()
# with torch.no_grad():
...
# # Calculate the confusion matrix for the entire validation set using the final predictions
